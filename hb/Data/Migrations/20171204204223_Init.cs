        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReciverAccountId = table.Column<int>(nullable: true),
                    ReciverId = table.Column<string>(nullable: true),
                    SenderAccountId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_BankAccounts_ReciverAccountId",
                        column: x => x.ReciverAccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_AspNetUsers_ReciverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ReciverAccountId",
                table: "Transactions",
